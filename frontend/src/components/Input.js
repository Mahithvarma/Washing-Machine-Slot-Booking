...
const Input = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    let name = selectedName?.current.value;
    ...
    if (validate()) {
      Swal.fire({
        title: "Are you sure?",
        text: `Bbook the slot at ${time} on ${date}!`,
        icon: "warning",
        ...
        if (result.isConfirmed) {
          const response = await axios.post(`${host}/bookings/add`, {
            name,
            time,
            date,
          });
  ...
  const validate = () => {
    ...
    if (name === "") {
      toast.error("Please select your name", toastOptions);
      return false;
    }
    if (date === "") {
        ...
        <form className="flex justify-between " onSubmit={handleSubmit}>
          <div className="mb-5 mx-5">
            ...
            >
              ...
              <option value="Gowri Shankar">Gowri Shankar</option>
              <option value="Siva Sankar">Siva Sankar</option>
              <option value="Abhinava Santhosh">Abhinava Santhosh</option>
              <option value="Mani Nandyala">Mani Nandyala</option>
              <option value="Avinash Kanchi">Avinash Kanchi</option>
              <option value="Akhil Abothu">Akhil Abothu</option>
              <option value="Mahith varma">Mahith varma</option>
              <option value="Revanth">Revanth</option>
              <option value="Mahajan">Mahajan</option>
              <option value="Hari">Hari</option>
              <option value="Satyavanth">Satyavanth</option>
